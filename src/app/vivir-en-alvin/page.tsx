...
export const metadata: Metadata = {
  title: 'Vivir en Alvin | RentInAlvin.com',
  description: 'Información sobre vivir en Alvin, Texas con Yellowstone Asset Management.',
};
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#F4EEE4', color: '#1A1815', fontFamily: "'Inter', sans-serif" }}>
      <header style={{ padding: '24px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(26,24,21,0.12)' }}>
        <a href="/es" style={{ display: 'flex', alignItems: 'center', gap: 12, textDecoration: 'none', color: '#1A1815' }}>
        ...
        <a href="/es" style={{ fontSize: 14, fontWeight: 600, color: '#1F3A2E', textDecoration: 'none' }}>← Volver al inicio</a>
      </header>
