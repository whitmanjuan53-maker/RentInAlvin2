...
export default function Home() {
  ...
  return (
    <div style={{ background: p.bg, color: p.ink, minHeight: '100vh' }}>
      ...
      <PropertyModal open={!!modalProp} onClose={() => setModalProp(null)} property={modalProp} onBookTour={() => { setBookingPropId('kings-manor'); setBookingOpen(true); }} p={p} displayFont={displayFont} locale="es" />
