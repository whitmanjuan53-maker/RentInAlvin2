...
const kingsHaven100Gallery = JSON.parse(readFileSync(new URL('../src/lib/kings-haven-100-gallery.json', import.meta.url), 'utf8'));
...
const COMMUNITIES = [
  ...
  { name: 'Kings Haven Apartments', addr: '100 S 2nd St', tag: 'Apartments', units: '2BR · 1BA · 850 sq ft', price: 'from $850', note: 'Quiet block near 100 S 2nd; renovated interiors.', gallery: kingsHaven100Gallery },
  { name: 'French Quarter Residency', addr: '2550 S Bypass 35', tag: 'Apartments', units: '2BR · 1BA · 850 sq ft', price: 'from $950', note: 'Larger community along the bypass with ample parking.', gallery: frenchQuarterGallery },
  { name: 'The White House Apartments', addr: '1606 W Sealy St', tag: 'Apartments', units: '2BR · 1BA · 850 sq ft', price: 'from $900', note: 'Classic white-clad apartments on a quiet residential street.', gallery: ['/images/white-house/mural-tropical-garden.jpg'] },
  { name: 'The Royal Oaks Townhomes', addr: '418 S Jackson St', tag: 'Townhome', units: '2BR · 2BA · 1,150 sq ft', price: 'from $1,350', note: 'Spacious townhomes under mature oak canopy.', gallery: royalOaksGallery, comingSoon: false },
];
